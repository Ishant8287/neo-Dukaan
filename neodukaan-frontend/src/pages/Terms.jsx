      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-32 w-full">
        ...
        <div className="space-y-8 text-slate-300 leading-relaxed">
          <section>
            ...
            <p>
              By using the RetailFlow platform, you agree to be bound by these
          ...
          <section>
            ...
            <p>
              RetailFlow provides an integrated POS, inventory management, and
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>Maintain the confidentiality of your RetailFlow account.</li>
